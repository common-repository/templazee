...
/* harmony import */ var _splidejs_react_splide_css_core__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @splidejs/react-splide/css/core */ "./node_modules/@splidejs/react-splide/dist/css/splide-core.min.css");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./editor.scss */ "./src/slider/editor.scss");
 ...
 * @type {string[]}
 */
const ALLOWED_BLOCKS = ["templazee/slides"];
const TEMPLATE = [["templazee/slides"], ["templazee/slides"]];
function SliderEditContainer({
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_splidejs_react_splide__WEBPACK_IMPORTED_MODULE_7__.SplideTrack, null, innerBlocksProps.children)))));
}
  ...
  updateColumns(previousColumns, newColumns) {
    ...
    if (isAddingColumn) {
      innerBlocks = [...innerBlocks, ...(0,lodash__WEBPACK_IMPORTED_MODULE_1__.times)(newColumns - previousColumns, () => {
        return (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_6__.createBlock)("templazee/slides");
      })];
    } else {
...
function save(props) {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...blockProps
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_splidejs_react_splide__WEBPACK_IMPORTED_MODULE_2__.Splide, {
    hasTrack: false,
    "aria-label": "..."
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_splidejs_react_splide__WEBPACK_IMPORTED_MODULE_2__.SplideTrack, null, innerBlocksProps.children)));
}
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"templazee/slider","category":"templazee","title":"Slider","description":"Block to add slider to your content.","attributes":{"blockId":{"type":"string"}},"supports":{"anchor":true,"align":["wide","full"],"html":false},"textdomain":"slider","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
