...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"templazee/testimonial","title":"Testimonial","category":"templazee","parent":["templazee/testimonials"],"description":"Single testimonial block to be used with Testimonials block","supports":{"html":false},"textdomain":"testimonial","editorScript":"file:./index.js","editorStyle":"file:./index.css"}');
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/testimonial/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  edit: ({
    ...
    const classes = classnames__WEBPACK_IMPORTED_MODULE_3___default()('templazee-testimonial-item', {});
    ...
    const template = [['core/group', {
      ...
      content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sit amet est massa. Sed enim massa, mattis at libero nec, bibendum ultricies augue.',
      align: 'center'
    }], ['core/heading', {
      content: 'John Leo',
      textAlign: 'center',
