...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"templazee/slides","title":"Slide","category":"templazee","parent":["templazee/slider"],"description":"Single Slide block to be used with Slider block","supports":{"html":false},"textdomain":"slides","editorScript":"file:./index.js","editorStyle":"file:./index.css"}');
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  edit: ({
    ...
    const classes = classnames__WEBPACK_IMPORTED_MODULE_3___default()('splide__slide', {});
