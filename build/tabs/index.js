...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"templazee/tabs","title":"Tab","icon":"screenoptions","category":"widgets","parent":["templazee/tab"],"description":"Single Tab block to be used with Tabs block","supports":{"anchor":true,"reusable":false,"html":false,"color":{"gradients":true,"link":true,"__experimentalDefaultControls":{"background":true,"text":true}},"spacing":{"padding":true,"__experimentalDefaultControls":{"padding":true}},"__experimentalLayout":true},"textdomain":"Tabs","editorScript":"file:./index.js","editorStyle":"file:./index.css"}');
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  edit: ({
    ...
    const classes = classnames__WEBPACK_IMPORTED_MODULE_3___default()('tab-content', {});
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "templazee-tab-content-area",
      ...innerBlocksProps
    });
  },
  save: ({
